  ...
  *//////////////////////////////////////////////////
  function loginSet(msg, auth){// msg-메시지, auto-권한
      ...
      $(function(){ /// jQB //////////////////
          ...
          $(".sns a").eq(4)
          .attr("title","로그아웃").css({"color":"blue"})

          // 3. 로그아웃 클릭시 로그아웃하기
          // 주의: linksys.js에 "로그아웃" 예외 처리 필요
          // 이것을 안해주면 sns 중 하나로 분류되어 404새창이 뜸
          .click(function(){
...
<%
	/////////////////////////////////////////////////////////////
// 권한 세션값 읽어오기 : 먼저 값을 읽고 권한 중 "A" 또는 "S"이묜
// 환영 메세지 에 "관리자"라는 말을 추가해준다
String auth = session.getAttribute("auth").toString();
// 어드민이면 "관리자" 할당
String admin = " 회원"; // 일반 회원은 "회원"으로 출력
