...
// MVC  모델에서 컨트롤러 역할을하는 클래스
// 역할 : DB관련 작업 및 비즈니스로직 수행, 뷰 생성
...
public class ListController {
	...
	// 생성자 메서드는 값을 리턴할 수 없으므로 별도의 메서드를 생성하여 리스트 결과값을 리스트 페이지에 전달한다
	//////////////////////////////
	// 리스트 뷰를 구성하여 리턴하는 메서드
	//////////////////////////////
	public String setList(String pgNum) {
		// pgNum은 리스트페이지에서 생성 시 파라미터값을 전달해준다
